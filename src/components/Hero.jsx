            ...
            <div className="flex justify-center px-4 mb-24 text-center text-white hero-text sm:px-6 lg:px-8">
              <div className="flex flex-col items-center max-w-screen-lg mx-6">
                ...
                <h3 className="mt-6 mb-2">
                  Don{"'"}t you want to stop doomscrolling all of your streaming
                  platforms?
                </h3>
                <h3>
                  Let us help you watch your movie instead of searching for it.
                </h3>
              </div>
            </div>
          </>
              ...
              <div class="mx-auto mt-10 flex justify-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8">
                <div class="text-center ">
                  ...
                  <p class="mx-auto mt-3 max-w-xl text-lg text-gray-500 dark:text-slate-400 sm:mt-5 md:mt-5">
                    Stop doomscrolling for your next movie! Let us help you watch your movie instead of searching for
                    it.
                  </p>
